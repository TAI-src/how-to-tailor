...
We will solicit submissions in the form of short papers or extended abstracts describing real-world optimization problems, modeling choices, or tailoring experiences. The session will open with one invited keynote talk, highlighting challenges and lessons learned when deploying optimization in practice. This will be followed by interactive sessions, presentations of accepted contributions (10 minutes), and a panel discussion. The panel’s aim is bringing together algorithm designers and application experts to discuss recurring patterns, mismatches between theory and practice, and opportunities for systematic methodology.

The workshop will conclude with an open discussion synthesizing key insights and identifying shared research directions and potential community resources. 
